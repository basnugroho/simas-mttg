...
<html lang="en">
  ...
  <head>
    ...
    <?php
      ...
      $rawTitle = $title ?? 'Administrator';
      // Avoid duplicating prefix if already present
      $fullTitle = Str::startsWith($rawTitle, $baseTitlePrefix) ? $rawTitle : $baseTitlePrefix . $rawTitle;
    ?>
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-mini sidebar-collapse bg-body-tertiary">
    ...
    <div class="app-wrapper">
      <!--begin::Header-->
      @include('components.administrator._navbar')
      <!--end::Header-->
      <!--begin::Sidebar-->
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        @include('components.administrator._sidebar')
        </div>
        <!--end::Sidebar Wrapper-->
      </aside>
      <!--end::Sidebar-->
